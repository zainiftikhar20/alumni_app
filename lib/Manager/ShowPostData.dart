...
class ShowPostData extends StatefulWidget {

  const ShowPostData({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ShowPostDataState();
}

// ignore: camel_case_types
class _ShowPostDataState extends State<ShowPostData>
