...
class Student_registration extends StatefulWidget {
  Student_registration({Key key}) : super(key: key);
  @override
  _Student_registrationState createState() => _Student_registrationState();
}
                  ...
                  onPressed: (){
                     ...
                     if (_globalKey.currentState.validate()) {
                       ...
                       createUserWithEmailAndPassword(email: emailController.text, password: pswdController.text)
                         ...
                         (context, MaterialPageRoute(builder: (context)=>Student_Login()),
                       ),)
